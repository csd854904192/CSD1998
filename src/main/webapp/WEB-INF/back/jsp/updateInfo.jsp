...
<head>
    ...
    <script  src="${pageContext.request.contextPath}/back/js/form.js"></script>
</head>
<body>
...
<form class="layui-form" action="../formServlet" lay-filter="test1" onsubmit="return false;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="userid" id="userid" class="layui-input" autocomplete="on" disabled="disabled">
        </div>
    </div>
    <div class="layui-form-item">
