...
<head>
    ...
    <script src="${pageContext.request.contextPath}/back/js/BackManager.js"></script>
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a href="javascript:void(0)"
                           title="${pageContext.request.contextPath}/admin/path/Privilege"
                           onclick="changePath(this)">授权管理</a>
                    </dd>
                </dl>
            </li>
        </ul>
