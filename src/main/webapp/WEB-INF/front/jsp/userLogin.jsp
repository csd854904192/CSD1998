...
<head>
    ...
    <script src="<%=path+"/front/js/UserLogin.js"%>"></script>
</head>
<style>
    .login {
        margin-top: 15%;
...
<%--                <button data-method="dialog" class="layui-btn" lay-filter="add">注册</button>--%>
                <button type="reset" class="layui-btn layui-btn-primary" onclick="menu()">重置</button>
            </div>
        </div>
    </form>
</div>
<script>
    function menu() {
       window.location=path+"/back/jsp/Menu.jsp"
    }
</script>
</body>
</html>
